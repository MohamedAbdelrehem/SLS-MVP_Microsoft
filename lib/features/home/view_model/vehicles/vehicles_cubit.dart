...
class VehiclesCubit extends Cubit<VehiclesState> {
  ...
  Future<void> addVehicle(
      ...
      required String vehiclemodel3durlpath}) async {
    ...
    try {
      await FirebaseFirestoreServiceVehicles().addVehicle(
          vehicleid: vehicleid,
          vehicletype: vehicletype,
          vehiclecolor: vehiclecolor,
          vehichlemodel: vehichlemodel,
          vehiclefuelcapciaty: vehiclefuelcapciaty,
          vehiclefueltype: vehiclefueltype,
          vehiclemodel3durlpath: vehiclemodel3durlpath);
...
//! if viechle name is in firestore inside user add it to the list
    emit(VehichlesGetLoading());
    final database = FirebaseDatabase.instance.ref('/car');
